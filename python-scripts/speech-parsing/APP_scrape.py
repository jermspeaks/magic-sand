...
def get_docs(
    url="https://www.presidency.ucsb.edu/advanced-search?field-\
			 keywords=&field-keywords2=&field-keywords3=&from%5Bdate%5D=&to%5Bd\
			 ate%5D=&person2=200301&category2%5B%5D=&items_per_page=100",
    name="trump",
    outfile_name="docs.json",
    max_page_count=100,
):
    """
        ...
        for div in data:
            ...
            for a in links:
                ...
                if "/people/president" != str(a["href"])[:17]:
                    ...
                    title = soup_1.findAll(
                        "div",
                        attrs={
                            "class": "field-ds-doc-t\
														itle"
                        },
                    )
                    for t in title:
                    ...
                    text1 = soup_1.findAll(
                        "div",
                        attrs={
                            "class": "field-docs-con\
														tent"
                        },
                    )
                    for t in text1:
